...
int main()
{
    ...
    for (unsigned int i = 0; i < amount; i++)
    {
        ...
        float y = (displacement * 0.4f) - 2.3; // keep height of asteroid field smaller compared to width of x and z
        displacement = (rand() % (int)(2 * offset * 100)) / 100.0f - offset;
    ...
    // -----------------------------------------------------------------------------------------------------------------------------------
    for (unsigned int i = 0; i < cake.meshes.size(); i++)
    {
        unsigned int VAO = cake.meshes[i].VAO;
...
void processInput(GLFWwindow *window)
{
    ...
    if (glfwGetKey(window, GLFW_KEY_R) == GLFW_PRESS)
        svetlo = glm::vec3(5.0f, 0.0f, 0.0f);
    if (glfwGetKey(window, GLFW_KEY_G) == GLFW_PRESS)
        svetlo = glm::vec3(0.0f, 5.0f, 0.0f);
    if (glfwGetKey(window, GLFW_KEY_B) == GLFW_PRESS)
        svetlo = glm::vec3(0.0f, 0.0f,15.0f);
